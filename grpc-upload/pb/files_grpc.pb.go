...
func (x *imageServiceUploadImageClient) Send(m *UploadRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *imageServiceUploadImageClient) CloseAndRecv() (*UploadResponse, error) {
...
func (x *imageServiceUploadImageServer) SendAndClose(m *UploadResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *imageServiceUploadImageServer) Recv() (*UploadRequest, error) {
	m := new(UploadRequest)
